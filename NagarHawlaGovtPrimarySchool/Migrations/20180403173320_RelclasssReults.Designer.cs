...
namespace NagarHawlaGovtPrimarySchool.Migrations
{
    ...
    [Migration("20180403173320_RelclasssReults")]
    partial class RelclasssReults
    {
            ...
            modelBuilder.Entity("NagarHawlaGovtPrimarySchool.Models.RelClassSubject", b =>
                {
                    ...
                    b.Property<int?>("RelResultresult_id");
                    ...
                    b.HasIndex("RelResultresult_id");

                    b.ToTable("RelClassSubjects");
                });

            modelBuilder.Entity("NagarHawlaGovtPrimarySchool.Models.RelResult", b =>
                {
            ...
            modelBuilder.Entity("NagarHawlaGovtPrimarySchool.Models.RelClassSubject", b =>
                {
                    ...
                    b.HasOne("NagarHawlaGovtPrimarySchool.Models.RelResult")
                        .WithMany("subject_list")
                        .HasForeignKey("RelResultresult_id");
                });
