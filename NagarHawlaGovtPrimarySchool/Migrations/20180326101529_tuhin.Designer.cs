...
namespace NagarHawlaGovtPrimarySchool.Migrations
{
    ...
    [Migration("20180326101529_tuhin")]
    partial class tuhin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NagarHawlaGovtPrimarySchool.Models.RelClassSection", b =>
                {
                    ...
                    b.Property<int>("class_id1");

                    b.Property<int>("sec_id1");

                    b.HasKey("id");

                    b.HasIndex("class_id1");
            ...
            modelBuilder.Entity("NagarHawlaGovtPrimarySchool.Models.RelClassSection", b =>
                {
                    b.HasOne("NagarHawlaGovtPrimarySchool.Models.Class", "class_id")
                        .WithMany()
                        .HasForeignKey("class_id1")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NagarHawlaGovtPrimarySchool.Models.Section", "sec_id")
                        .WithMany()
                        .HasForeignKey("sec_id1")
                        .OnDelete(DeleteBehavior.Cascade);
                });
